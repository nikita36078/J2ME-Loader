...
import ru.playsoftware.j2meloader.donations.google.util.IabHelper;
import ru.playsoftware.j2meloader.donations.google.util.IabResult;
import ru.playsoftware.j2meloader.donations.google.util.Purchase;
...
public class DonationsFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (mPaypalEnabled) {
			...
			btPayPal.setOnClickListener(this::donatePayPalOnClick);
		}
	}
	...
	private void buildFlattrView() {
		...
		mFlattrWebview.setOnTouchListener((view, motionEvent) -> {
