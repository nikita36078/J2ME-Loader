...
import static android.opengl.GLES20.GL_CONSTANT_COLOR;
...
import static android.opengl.GLES20.GL_FUNC_REVERSE_SUBTRACT;
...
import static com.mascotcapsule.micro3d.v3.Graphics3D.COMMAND_AFFINE_INDEX;
import static com.mascotcapsule.micro3d.v3.Graphics3D.COMMAND_AMBIENT_LIGHT;
import static com.mascotcapsule.micro3d.v3.Graphics3D.COMMAND_ATTRIBUTE;
import static com.mascotcapsule.micro3d.v3.Graphics3D.COMMAND_CENTER;
import static com.mascotcapsule.micro3d.v3.Graphics3D.COMMAND_CLIP;
import static com.mascotcapsule.micro3d.v3.Graphics3D.COMMAND_DIRECTION_LIGHT;
import static com.mascotcapsule.micro3d.v3.Graphics3D.COMMAND_END;
import static com.mascotcapsule.micro3d.v3.Graphics3D.COMMAND_FLUSH;
import static com.mascotcapsule.micro3d.v3.Graphics3D.COMMAND_LIST_VERSION_1_0;
import static com.mascotcapsule.micro3d.v3.Graphics3D.COMMAND_NOP;
...
import static com.mascotcapsule.micro3d.v3.Graphics3D.COMMAND_TEXTURE_INDEX;
import static com.mascotcapsule.micro3d.v3.Graphics3D.COMMAND_THRESHOLD;
import static com.mascotcapsule.micro3d.v3.Graphics3D.ENV_ATTR_LIGHTING;
import static com.mascotcapsule.micro3d.v3.Graphics3D.ENV_ATTR_SEMI_TRANSPARENT;
import static com.mascotcapsule.micro3d.v3.Graphics3D.ENV_ATTR_SPHERE_MAP;
import static com.mascotcapsule.micro3d.v3.Graphics3D.ENV_ATTR_TOON_SHADING;
import static com.mascotcapsule.micro3d.v3.Graphics3D.PATTR_BLEND_SUB;
import static com.mascotcapsule.micro3d.v3.Graphics3D.PATTR_COLORKEY;
import static com.mascotcapsule.micro3d.v3.Graphics3D.PDATA_COLOR_PER_COMMAND;
import static com.mascotcapsule.micro3d.v3.Graphics3D.PDATA_COLOR_PER_FACE;
import static com.mascotcapsule.micro3d.v3.Graphics3D.PDATA_NORMAL_PER_FACE;
import static com.mascotcapsule.micro3d.v3.Graphics3D.PDATA_NORMAL_PER_VERTEX;
import static com.mascotcapsule.micro3d.v3.Graphics3D.PDATA_POINT_SPRITE_PARAMS_PER_CMD;
import static com.mascotcapsule.micro3d.v3.Graphics3D.PDATA_POINT_SPRITE_PARAMS_PER_FACE;
import static com.mascotcapsule.micro3d.v3.Graphics3D.PDATA_POINT_SPRITE_PARAMS_PER_VERTEX;
import static com.mascotcapsule.micro3d.v3.Graphics3D.PDATA_TEXURE_COORD;
import static com.mascotcapsule.micro3d.v3.Graphics3D.PRIMITVE_LINES;
import static com.mascotcapsule.micro3d.v3.Graphics3D.PRIMITVE_POINTS;
import static com.mascotcapsule.micro3d.v3.Graphics3D.PRIMITVE_POINT_SPRITES;
import static com.mascotcapsule.micro3d.v3.Graphics3D.PRIMITVE_QUADS;
import static com.mascotcapsule.micro3d.v3.Graphics3D.PRIMITVE_TRIANGLES;
